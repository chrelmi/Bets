...
def callback(file,squadracs,squadratr):
	...
	storico1=tkinter.Label(root,text="Partite totali in casa "+squadracs+": "+"\nPartite vinte in casa "+squadracs+": "+"\nPartite perse in casa "+squadracs+": ",bg="#000000",fg="#FFFFFF")
	storico1.config(font=("Noto Sans Mono CJK JP Bold", 16))
	storico1.grid(row=5,column=0,columnspan=2,sticky=W)
	ris1=tkinter.Label(root,text=countcs+"\n"+countvc+"\n"+countpcs,bg="#000000",fg="#FFFFFF")
	...
	storico2=tkinter.Label(root,text="Partite totali in trasferta "+squadratr+": "+"\nPartite vinte in trasferta "+squadratr+": "+"\nPartite perse in trasferta "+squadratr+": ",bg="#000000",fg="#FFFFFF")
	storico2.config(font=("Noto Sans Mono CJK JP Bold", 16))
	storico2.grid(row=6,column=0,columnspan=2,sticky=W,pady=10)
	ris2=tkinter.Label(root,text=countr+"\n"+countvtr+"\n"+countptr,bg="#000000",fg="#FFFFFF")
